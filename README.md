About vaex-viz-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vaex-viz-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3624&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-viz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-viz` can be installed with `conda`:
...
```
mamba install vaex-viz
```

It is possible to list all of the versions of `vaex-viz` available on your platform with `conda`:
...
```
mamba search vaex-viz --channel conda-forge
```
...
mamba repoquery search vaex-viz --channel conda-forge

# List packages depending on `vaex-viz`:
mamba repoquery whoneeds vaex-viz --channel conda-forge

# List dependencies of `vaex-viz`:
mamba repoquery depends vaex-viz --channel conda-forge
```
